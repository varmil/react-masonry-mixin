    ...
    return function(reference, options) {
        return {
            ...
            initializeMasonry: function(force) {
                if (!this.masonry || force) {
                    ...
                    this.masonry.on('layoutComplete', function(msnryInstance, laidOutItems) {
                        console.log('Masonry layout completed : ', laidOutItems);
                    });
                }
            },
            ...
            shouldPerformLayout: function() {
                ...
                console.info('[react-masonry-mixins] shouldPerformLayout start diff', diff);
            ...
            componentDidMount: function() {
                console.info('[react-masonry-mixins] componentDidMount');
                if (!isBrowser) return;
                var self = this;
            ...
            componentDidUpdate: function() {
                console.info('[react-masonry-mixins] componentDidUpdate');
                if (!isBrowser) return;
                var self = this;
